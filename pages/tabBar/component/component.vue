	...
	<view class="container">
		...
		<view class="canvasView">
			<view class="canvas-bar">
				...
				<button class="update-btn" type="primary" size="mini" @click="sendRequest">修改饼状图数据</button>
			</view>
	...
	export default {
		...
		methods: {
			...
			sendRequest: function() {
				this.loading = true
				uni.request({
					url: 'http://biapi.yesapi.cn/?service=App.Analysis.IPAnalysis&app_key=0D19F4F8568B4232213F87FC45C03253&start_time=2019-03-07&end_time=2019-04-07&page=1&sortType=numASC&perpage=20',
					dataType: 'text',
					data: {},
					success: (res) => {
